...
window.ITD_PROJECTS = [
  ...
  { title: "NAMENLOS WEBSITE",      category: "BRAND",      stack: "HTML",       access: "PRIVATE", status: "live" },
  ...
  { title: "TATTOO DESIGN EDITOR",  category: "PRODUCT",    stack: "TYPESCRIPT", access: "PRIVATE", status: "live" },
  { title: "EVE SLACK AGENT",       category: "AI",         stack: "TYPESCRIPT", access: "PUBLIC",  status: "paused" },
  { title: "EVE CHAT",              category: "AI",         stack: "TYPESCRIPT", access: "PRIVATE", status: "offline" },
  { title: "BRANDCULTURA REDESIGN", category: "BRAND",      stack: "HTML",       access: "PUBLIC",  status: "paused" },
