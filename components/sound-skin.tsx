          ...
          <Reveal>
            ...
            >
              <Image
                ...
                className="object-cover opacity-95 contrast-110 saturate-75 transition-transform duration-1000 ease-out group-hover:scale-[1.035] motion-safe:animate-[sound-drift_16s_ease-in-out_infinite]"
              />
