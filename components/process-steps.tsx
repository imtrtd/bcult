      ...
      <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2 md:mt-6 md:grid-cols-3">
        {t.steps.map((step, i) => (
          <Reveal key={step[0]} delay={i * 90}>
            <div className="premium-panel flex min-h-full flex-col gap-4 p-5 transition-colors hover:border-pink sm:min-h-64 sm:p-6">
              ...
              <h3 className="text-xl font-semibold leading-tight text-pink sm:text-2xl">{step[1]}</h3>
