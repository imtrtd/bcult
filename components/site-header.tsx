...
const HREFS = ['#signal', '#sound-skin', '#analyse', '#shape', '#dna', '#kontakt']

export function SiteHeader() {
  const { copy, locale, setLocale } = useLocale()
  const labels = [copy.nav.signal, copy.nav.sound, copy.nav.spectrum, copy.nav.shape, copy.nav.dna, copy.nav.contact]
  return (
